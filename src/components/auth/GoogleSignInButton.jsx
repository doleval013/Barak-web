/**
 * GoogleSignInButton — Renders the official Google Sign-In button
 * 
 * Uses Google Identity Services to render a branded sign-in button.
    ...
    return (
        <div className={className} ref={containerRef}>
            ...
            {!googleLoaded && (
                <button 
                    disabled 
                    className="flex items-center gap-3 px-6 py-3 bg-white border border-slate-200 rounded-lg text-slate-400 text-sm font-medium cursor-not-allowed"
                >
