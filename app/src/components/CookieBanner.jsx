    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.1)] border border-gray-100 p-6 md:flex items-center justify-between gap-6">
