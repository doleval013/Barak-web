...
const programs = [
    {
        ...
        icon: School,
        content: 'תוכניות שנתיות וליווי כיתות, עבודה צמודה עם צוותים פדגוגיים, קבוצות חברתיות ופרויקטים טיפוליים משולבי יעדים לימודיים ורגשיים. אפשר לשלב תהליכי הכשרה לצוותי הוראה ולבנות מעטפת מותאמת לכל שכבת גיל.'
    },
    {
        id: 'events',
    ...
    },
    {
        ...
        icon: HeartHandshake,
        content: 'התאמות ייעודיות עבור PTSD, קשישים, נוער בסיכון, מרכזי יום וחברות הייטק שמחפשות פעילות גיבוש עם ערך. משלבים כלים טיפוליים, תרגילי נשימה ומיינדפולנס, ועבודה קבוצתית שמחזקת אמון ותחושת ביטחון.',
