...
let content = fs.readFileSync('src/components/TeamWorkshopLanding.jsx', 'utf8');

// 1. Rename Component
content = content.replace(/function TeamWorkshopLanding\(\)/g, 'function GefenLanding()');
...
// 4. Replace Video URL
content = content.replace(/kZMeB9DZNAs/g, 'HC4Sm4KhXlU');

// 5. Overwrite translations
...
if (startIdx !== -1 && endIdx !== -1) {
    content = content.substring(0, startIdx) + new_translations + '\\n\\n' + content.substring(endIdx);
} else {
